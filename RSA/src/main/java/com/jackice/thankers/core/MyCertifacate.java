package com.jackice.thankers.core;
...
public class MyCertifacate {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("publicKey is:"+certificate.getPublicKey().toString());
        System.out.println("sigalgname is:"+certificate.getSigAlgName().toString());
        System.out.println("issuerDN is:"+certificate.getIssuerDN().toString());
        System.out.println("signature is:"+certificate.getSignature().toString());
        try {
            System.out.println("certificate.encoded is:"+certificate.getEncoded().length);
        ...
        System.out.print(publicKey.toString());
